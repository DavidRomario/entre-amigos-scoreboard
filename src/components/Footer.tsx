    ...
    <footer className="gradient-hero text-white py-16">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {/* Team Info */}
          <div>
            <h3 className="text-2xl font-bold mb-6 text-victory">Entre Amigos FC</h3>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <span className="text-white/80">Taxa de Vitórias</span>
                <span className="font-bold text-victory">75%</span>
              </div>
              <div className="flex items-center justify-between">
          ...
          <div>
            ...
            <div className="space-y-4 text-white/80">
              <div>
                <div className="font-medium text-white">Treinos</div>
                <div className="text-sm">Sábados - 14:00h</div>
                <div className="text-sm">Campo do Parque Central</div>
              </div>
              <div>
                <div className="font-medium text-white">Jogos</div>
                <div className="text-sm">Domingos - 09:00h</div>
                <div className="text-sm">Diversos campos da cidade</div>
              </div>
              <div>
                <div className="font-medium text-white">Contato</div>
                <div className="text-sm">WhatsApp: (11) 99999-9999</div>
                <div className="text-sm">entreamigos@email.com</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="flex items-center gap-2 mb-4 md:mb-0">
              ...
              <span className="text-sm text-white/80">
                © 2024 Entre Amigos FC. Todos os direitos reservados.
              </span>
            </div>
            <div className="flex items-center gap-2 text-sm text-white/80">
              <Users className="w-4 h-4" />
              <span>Feito com ❤️ pela família Entre Amigos</span>
            </div>
          </div>
        </div>
      </div>
